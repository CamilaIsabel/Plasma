<template>
  <form class="flex flex-col" @submit.prevent="submit">
    <h1 class="text-2xl text-center font-bold mb-4">Editar artículo</h1>

    <div class="flex flex-row flex-wrap">
      <div class="w-full pr-0 md:w-1/2 md:pr-5 flex flex-col text-left">
        <img
          ref="image"
          :src="imageURL ? imageURL : '/sin-imagen.jpg'"
      ...
      <div class="w-full">
        <Input v-model="description" mode="textarea" label="Descripción" />
        <div
...
export default {
  ...
  created() {
    ...
    this.displayName = article.displayName;
    this.code = article.code;
    this.sellPrice = article.sellPrice;
    this.buyPrice = article.buyPrice;
    this.stock = article.stock;
    this.uselessItemCount = article.uselessItemCount;
    this.amountDamaged = article.amountDamaged;
